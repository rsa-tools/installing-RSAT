...
RSAT Docker containers are available at https://hub.docker.com/r/biocontainers/rsat/tags . This docker images can be used as a base to build Apptainer contianers
...
For convinence, in this tutorial al binded paths will be inside a rsat-paths 
