...
- for the Macintosh computers with an **Apple Silicon processor** (M1/M2/M3), you absolutely need to download the **"arm" version** of the Ubuntu installation disk image. `ubuntu-24.04.3-desktop-arm64.iso`

- for other computers, the **"amd" install disk** is fine: `ubuntu-24.04.3-desktop-arm64.iso`
