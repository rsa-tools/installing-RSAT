...
- **Ubuntu 18.04.1 (Bionic Beaver)** [ubuntu-18.04-desktop-amd64.iso](http://releases.ubuntu.com/releases/18.04/ubuntu-18.04.1-desktop-amd64.iso) ( Gb).
...
- File location and size
    ...
    - name of virtual hard drive file:    rsat-vb-2018-12_hdd
...
| Your computer's name | rsat-vb-2018-12 |
...
- The IP address above may be different on your computer, depending on the network settings of your VirtualBox and on the number of Virtual Machines currently running. If the address `192.168.56.101` does not work, you can obtain the IP address by typing `ifconfig` in a terminal on your virtual machine. 
...
|	Version		  | 2018-12 |
|	Description	| Regulatory Sequence Analysis Tools (RSAT, http://rsat.eu/), version 2018-12, installed on an Ubuntu 16.04 Virtual Machine. |
...
time split -b ${SPLIT_SIZE} ${SOURCE_DIR}/rsat-vb-2018-12_${VERSION}.ova ${TARGET_DIR}/appliances/rsat-vb-2018-12_${VERSION}.ova.split${SPLIT_SIZE}_
```
